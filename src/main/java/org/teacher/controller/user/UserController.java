...
public class UserController {
    ...
    public ResponseEntity<UserResponseDto> createUserByToken(
            @RequestParam("token") UUID claimToken,
            @RequestBody UserRequestDto userDto) {
        UserResponseDto responseDto = userService.registerStudent(claimToken, userDto);
        return ResponseEntity
                .created(URI.create("/users/" + responseDto.userId()))
                .body(responseDto);
    }
