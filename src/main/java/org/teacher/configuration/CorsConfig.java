...
public class CorsConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://teacher-app-frontend-mnsu.onrender.com")); // ✅ Разрешаем фронт
        ...
        configuration.setAllowCredentials(true); // ✅ Разрешаем отправку cookies и авторизацию
